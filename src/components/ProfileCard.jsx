  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-md transform transition-all hover:scale-105 hover:shadow-3xl">
      ...
      <div className="pt-16 pb-8 px-8 text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-1">Aleyna Kaya</h2>
        <p className="text-indigo-600 font-medium mb-6">Backend Developer</p>
        
        <p className="text-gray-600 text-sm mb-6 leading-relaxed">
          Backend geliştirme alanında uzmanlaşmış bir yazılım geliştiricisiyim. 
          Modern teknolojiler ve en iyi pratiklerle ölçeklenebilir çözümler üretiyorum.
        </p>
        ...
        <div className="flex justify-center gap-4 mt-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md"
