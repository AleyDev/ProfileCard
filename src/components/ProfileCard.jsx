      ...
      <div className={`fixed inset-0 transition-all duration-500 relative overflow-hidden`}>
        ...
        <div className="w-full h-full flex items-center justify-center p-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className={`w-[410px] h-[410px] rounded-3xl transition-all duration-500 ${darkMode ? 'bg-green-900/30' : 'bg-purple-100/30'} blur-3xl`}></div>
          </div>

          <div
            ref={cardRef}
            className={`${darkMode ? 'bg-black/90 backdrop-blur-xl' : 'bg-white/90 backdrop-blur-xl'} rounded-2xl shadow-[0px_8px_60px_-10px_rgba(13,28,39,0.6)] w-[360px] h-[360px] relative pt-[69px] pb-7 px-7 border ${darkMode ? 'border-green-500/30' : 'border-gray-200/50'} flex flex-col z-10 transition-all duration-500`}
            style={{
          ...
          >
            ...
            <button
              ...
              className={`absolute top-3 right-3 w-[45px] h-[45px] rounded-full ${darkMode ? 'bg-gradient-to-br from-yellow-400 to-yellow-600' : 'bg-gradient-to-br from-gray-700 to-gray-900'} flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 z-20`}
            ...
            <div className="flex justify-center -mt-[50px] mb-4">
              <div
                className={`w-[105px] h-[105px] rounded-full overflow-hidden transition-all duration-300 hover:scale-110 cursor-pointer group relative`}
                style={{
                  boxShadow: darkMode
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center w-full">
              ...
              <p
                ref={titleRef}
                className={`text-sm font-medium ${darkMode ? 'text-green-400' : 'text-[#324e63]'} mb-4 transition-colors duration-300 min-h-[22px] text-center`}
              >
                {typedText}
              ...
              >
                <a
                  ...
                  className="w-[50px] h-[50px] rounded-full flex items-center justify-center text-white bg-gradient-to-br from-[#333333] to-[#626b73] shadow-[0px_7px_30px_rgba(63,65,67,0.6)] transition-all duration-300 hover:scale-125 hover:rotate-6 hover:shadow-[0px_10px_40px_rgba(63,65,67,0.8)]"
                  aria-label="GitHub"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-[50px] h-[50px] rounded-full flex items-center justify-center text-white bg-gradient-to-r from-[#405de6] via-[#5851db] via-[#833ab4] via-[#c13584] via-[#e1306c] to-[#fd1d1d] shadow-[0px_4px_30px_rgba(120,64,190,0.6)] transition-all duration-300 hover:scale-125 hover:-rotate-6"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-[50px] h-[50px] rounded-full flex items-center justify-center text-white bg-gradient-to-br from-[#000000] to-[#191919] shadow-[0px_7px_30px_rgba(0,0,0,0.6)] transition-all duration-300 hover:scale-125 hover:rotate-6"
                  aria-label="Medium"
                >
                  <svg className="w-[25px] h-[25px]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex justify-center items-center gap-2.5 flex-wrap">
                ...
                <a
                  ...
                  className={`${darkMode ? 'bg-gray-700' : 'bg-gray-600'} w-[50px] h-[50px] rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 hover:scale-125 hover:rotate-6`}
                  title="CV İndir"
                >
