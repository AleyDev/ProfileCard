      ...
      <div className="mt-[-35px] text-center px-5 pb-10">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-[55px] h-[55px] rounded-full flex items-center justify-center text-white bg-gradient-to-br from-[#000000] to-[#191919] shadow-[0px_7px_30px_rgba(0,0,0,0.6)] mx-4 transition-all duration-300 hover:scale-125 hover:rotate-6"
            aria-label="Medium"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
